...
const Search = () => {
  ...
  const [products] = useState([
    ...
    },
    {
      ...
      discount: 20,
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/L700001527_%EC%8B%A0%EB%B3%B4%EC%95%88%EB%82%B4%EC%84%9C_aespa_%EC%8B%B1%EA%B8%80_Dirty_Work_Dirty_Code_Ver._%EC%9E%90%EC%BC%93%EC%9D%B4%EB%AF%B8%EC%A7%80_1.jpg_2025-06-13_141625006122_thumb.jpeg',
    },
    {
      id: 3,
      ...
      discount: 20,
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/L700001526_aespa_%EC%8B%B1%EA%B8%80_%EC%8D%B8%EB%84%A4%EC%9D%BC_Dirty_Worker_Ver._1.jpg_2025-06-13_143508068794_thumb.jpeg',
    },
    {
      id: 4,
      ...
      status: 'Sold Out',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/L700001525_%EC%8B%A0%EB%B3%B4%EC%95%88%EB%82%B4%EC%84%9C_aespa_%EC%8B%B1%EA%B8%80_Dirty_Work_Dirty_Case_Ver._%EC%9E%90%EC%BC%93%EC%9D%B4%EB%AF%B8%EC%A7%80_1.jpg_2025-06-13_143242239469_thumb.jpeg',
    },
    {
      id: 5,
      ...
      status: 'Sold Out',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/%ED%8F%AC%ED%86%A0%EC%BD%9C%EB%A0%89%ED%8A%B8%EB%B6%81_%EC%8D%B8%EB%84%A4%EC%9D%BC.jpg_2025-02-28_153431036724_thumb.jpeg',
    },
    {
      id: 6,
      ...
      status: 'Sold Out',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/%EB%B2%84%EC%A6%88-%ED%8C%8C%EC%9A%B0%EC%B9%98-%ED%82%A4%EB%A7%81_%EC%8D%B8%EB%84%A4%EC%9D%BC.jpg_2025-02-28_153340451285_thumb.jpeg',
    },
    {
      id: 7,
      ...
      status: 'Sold Out',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/%EC%97%90%EC%96%B4%ED%8C%9F-%ED%8C%8C%EC%9A%B0%EC%B9%98-%ED%82%A4%EB%A7%81_%EC%8D%B8%EB%84%A4%EC%9D%BC.jpg_2025-02-28_153241619903_thumb.jpeg',
    },
    {
      id: 8,
      ...
      status: 'Sold Out',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/aespa_%EC%8D%B8%EB%84%A4%EC%9D%BC_2669_X_2669.jpg_2025-01-21_112350937285_thumb.jpeg',
    },
  ])
  ...
  const [events] = useState([
    {
      ...
      color: 'bg-green-400',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/P_9259_AESPA_16_Banner_Sub.jpg_2025-06-25_164423413372_thumb.jpeg',
    },
    {
      id: 2,
      ...
      color: 'bg-orange-500',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/AESPA_14_Banner_Sub.jpg_2025-06-05_094524852701_thumb.jpeg',
    },
    {
      id: 3,
      ...
      color: 'bg-purple-400',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/P_9259_AESPA_12_Banner_Sub.jpg_2025-06-23_155649006884_thumb.jpeg',
    },
    {
      id: 4,
      ...
      color: 'bg-green-400',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/aespa_The_5th_Mini_Album_Whiplash_LUCKY_DRAW_EVENT__2024-12-12_073920.jpeg',
    },
    {
      id: 5,
      ...
      color: 'bg-blue-400',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/aespa_The_5th_Mini_Album_Whiplash_SPECIAL_GIVEAWAY_EVENT__2024-12-12_070230.jpeg',
    },
    {
      id: 6,
      ...
      color: 'bg-yellow-400',
      image:
        'https://mystarroom-public-cdn.makestar.com/public/image/product/aespa_%EB%AF%B8%EB%8B%88_5%EC%A7%91_Whiplash_FAN_SIGNING_EVENT__2024-12-12_072458.jpeg',
    },
  ])
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-8 py-6">
            ...
            {visibleEvents.map((event) => (
              ...
              >
                ...
                <div className="px-4 py-2">
                  ...
                  <div
                    className={`${event.color} text-white text-xs font-medium px-2 py-1 inline-block rounded-sm mb-2`}
                  >
                    {event.type} <span className="ml-1">{event.date}</span>
                  </div>
                  <div className="bg-black text-white text-xs px-2 py-0.5 inline-block rounded">
                    {event.status}
                  </div>
                </div>
              </Link>
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-800 mb-4">
            Product{' '}
            <span className="text-pink-600">{filteredProducts.length}</span>
          </h2>
